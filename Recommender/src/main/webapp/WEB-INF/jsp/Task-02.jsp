...
<form id="myForm" action="${pageContext.request.contextPath}/SubmitTask" method="POST" onsubmit="return checkValues();">
	...
	<input type="hidden" name="TaskNumber" id="TaskNumber" value="Task02" >
	<input type="hidden" name = "UserId" id="UID" >
	<input type="hidden" name="Question_1_Text" id="Question_1_Text" value="1B" >
	<input type="hidden" name="Question_2_Text" id="Question_2_Text" value="2B" >
